    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-16">
        ...
        <div className="space-y-4 max-w-3xl mx-auto">
          <span className="text-xs font-bold uppercase tracking-widest text-secondary">Our Standards</span>
          ...
          {whyUsItems.map((item, idx) => (
            <motion.div
              ...
              whileHover={{
                ...
                borderColor: 'rgba(240, 90, 40, 0.5)',
              }}
            ...
            >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="p-3 w-12 h-12 rounded-xl bg-primary/5 text-primary dark:bg-secondary/10 dark:text-secondary group-hover:bg-primary group-hover:text-white dark:group-hover:bg-secondary dark:group-hover:text-forest-dark transition-colors duration-300 flex items-center justify-center">
                    {renderIcon(item.iconName)}
                  </div>
                  <div className="w-8 h-8 rounded-full border border-secondary flex items-center justify-center text-secondary text-xs font-mono font-bold">
                    0{idx + 1}
                  </div>
                </div>

                <div className="space-y-2">
                  <h3 className="font-serif-display text-lg font-bold text-primary dark:text-accent group-hover:text-secondary transition-colors duration-300">
                    {item.title}
                  </h3>
              ...
              <div className="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-neutral-800 to-secondary opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
            </motion.div>
          ))}
        </motion.div>
      </div>
